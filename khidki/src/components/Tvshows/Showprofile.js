  ...
  const apiii = async () => {
    try {
      const Mdata = await axios.get(
        `https://api.themoviedb.org/3/tv/${match.params.id}?api_key=7372ae765660f35a9b2e71883bb705a5&language=en-US`
      );
      const Cdata = await axios.get(
        `https://api.themoviedb.org/3/tv/${match.params.id}/credits?api_key=7372ae765660f35a9b2e71883bb705a5&language=en-US`
      );
      const linkdata = await axios.get(
        `https://api.themoviedb.org/3/tv/${match.params.id}/external_ids?api_key=7372ae765660f35a9b2e71883bb705a5`
      );
  ...
  const showModal = async () => {
    try {
      const response = await axios.get(
        `http://api.themoviedb.org/3/tv/${match.params.id}/videos?api_key=7372ae765660f35a9b2e71883bb705a5`
      );
